...
public class EconomicHeadlinesRequestInfoHandler {
	public static Logger log = Logger
			.getLogger(EconomicHeadlinesRequestInfoHandler.class.getName());

	public int handleRequestInfo(EconomicHeadlinesRequestInfo info) {
		...
		try {
			...
			String query = "insert into trdapi_db.economic_headlines_request_info (FROM_DATE, TO_DATE, PAGE_NO, RECORDS_PER_PAGE)"
					+ "values('"
					+ fromTime
					+ "' ,  '"
					+ toTime
	...
	public EconomicHeadlinesRequestInfo getRequestInfo(Date fromD) {
		DatabaseHandler dbHandler = new DatabaseHandler();
		try {

			String from = DateHelper.getStandardFormatUTC(fromD);
			String query = "select * from trdapi_db.economic_headlines_request_info where from_date = '"
	...
	public void updateInfo(EconomicHeadlinesRequestInfo info) {
		DatabaseHandler dbHandler = new DatabaseHandler();
		try {

			String query = "update trdapi_db.economic_headlines_request_info set TOTAL_RECORDS = "
